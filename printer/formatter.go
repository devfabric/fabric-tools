...
type Formatter interface {
	...
	FieldDecode(field string, value interface{})
...
func (p *displayFormatter) FieldDecode(field string, value interface{}) {
...
func (p *jsonFormatter) FieldDecode(field string, value interface{}) {
	if p.commaRequired {
		p.write(",")
	}
